...
/**
 * Prints a particular instance of philosophers
 *
...
if ($coursemoduleid > 0) {
    $path = '/mod/philosophers/view.php/' . $coursemoduleid . '/';
...
$title = get_string('modulename', 'mod_philosophers');
$url = new moodle_url('/mod/philosophers/view.php', ['id' => $coursemoduleid]);
...
$PAGE->requires->js_call_amd('mod_philosophers/app-lazy','init', [
